...
* Please **do not** open issues or pull requests regarding the name in
...
A bug is a _demonstrable problem_ that is caused by the name in the repository.
Good bug reports are extremely helpful, so thanks!

Guidelines for bug reports:

0. **Validate and lint your name** &mdash; [validate your HTML](http://html5.validator.nu)
   and [lint your HTML](https://github.com/twbs/bootlint) to ensure your
   problem isn't caused by a simple error in your own name.
...
> reported. This might include the lines of name that you have identified as
...
| Google, Opera | Chrome, Chromium, Opera v15+ | Blink            | https://name.google.com/p/chromium/issues/list                                        | Click the "New issue" button.                            |
...
implementing features, refactoring name, porting to a different language),
otherwise you risk spending a lot of time working on something that the
project's developers might not want to merge into the project.

Please adhere to the [coding guidelines](#name-guidelines) used throughout the
...
4. Commit your changes in logical chunks. Please adhere to these [git commit
   ...
   or your name is unlikely be merged into the main project. Use Git's
...
includes name changes) and under the terms of the
...
By contributing your name, you agree to license your contribution under the [MIT License](LICENSE).
By contributing to the documentation, you agree to license your contribution under the [Creative Commons Attribution 3.0 Unported License](docs/LICENSE).

Prior to v3.1.0, Bootstrap's name was released under the Apache License v2.0.
